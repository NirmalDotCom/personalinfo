  ...
  return (
      <div className="about-container" id={id}>
        <div className="aboutMe-text">
          ...
          Want to know more about me? Feel free to <a className='resume' href="https://drive.google.com/file/d/1IQ9dmz1pd6jkb-y-YKz_tmKh3ts5i0H9/view?usp=drive_link" target="_blank" rel="noopener noreferrer">explore my resume.</a>
        </div>
